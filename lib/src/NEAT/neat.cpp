...
double NEAT::mutate_add_sensor_prob = 0;
...
bool NEAT::set_neat_params(std::map<std::string, double> mparam, bool output)
{

    NEAT::trait_param_mut_prob = mparam["trait_param_mut_prob"];
    NEAT::trait_mutation_power = mparam["trait_mutation_power"];  
    NEAT::linktrait_mut_sig = mparam["linktrait_mut_sig"]; 
    NEAT::nodetrait_mut_sig = mparam["nodetrait_mut_sig"]; 
    NEAT::weight_mut_power = mparam["weight_mut_power"]; 
    NEAT::recur_prob = mparam["recur_prob"]; 
    NEAT::disjoint_coeff = mparam["disjoint_coeff"];
    NEAT::excess_coeff = mparam["excess_coeff"];
    NEAT::mutdiff_coeff = mparam["mutdiff_coeff"];
    NEAT::compat_threshold = mparam["compat_threshold"];
    NEAT::age_significance = mparam["age_significance"]; 
    NEAT::survival_thresh = mparam["survival_thresh"]; 
    NEAT::mutate_only_prob = mparam["mutate_only_prob"];  
    NEAT::mutate_random_trait_prob = mparam["mutate_random_trait_prob"];
    NEAT::mutate_link_trait_prob = mparam["mutate_link_trait_prob"];
    NEAT::mutate_node_trait_prob = mparam["mutate_node_trait_prob"];
    NEAT::mutate_link_weights_prob = mparam["mutate_link_weights_prob"];
    NEAT::mutate_toggle_enable_prob = mparam["mutate_toggle_enable_prob"];
    NEAT::mutate_gene_reenable_prob = mparam["mutate_gene_reenable_prob"];
    NEAT::mutate_add_node_prob = mparam["mutate_add_node_prob"];
    NEAT::mutate_add_link_prob = mparam["mutate_add_link_prob"];
    NEAT::mutate_add_sensor_prob = mparam["mutate_add_sensor_prob"];
    NEAT::interspecies_mate_rate = mparam["interspecies_mate_rate"]; 
    NEAT::mate_multipoint_prob = mparam["mate_multipoint_prob"];     
    NEAT::mate_multipoint_avg_prob = mparam["mate_multipoint_avg_prob"];
    NEAT::mate_singlepoint_prob = mparam["mate_singlepoint_prob"];
    NEAT::mate_only_prob = mparam["mate_only_prob"]; 
    NEAT::recur_only_prob = mparam["recur_only_prob"]; 
    NEAT::pop_size = mparam["pop_size"];  
    NEAT::dropoff_age = mparam["dropoff_age"];  
    NEAT::newlink_tries = mparam["newlink_tries"];  
    NEAT::print_every = mparam["print_every"]; 
    NEAT::babies_stolen = mparam["babies_stolen"]; 
    NEAT::num_runs = mparam["num_runs"];
