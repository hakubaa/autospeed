...
public:
    ...
    static b2Vec2 SFVecToB2Vec(const sf::Vector2f& vector, bool scaleToMeters = true) {
        return b2Vec2(vector.x * (scaleToMeters ? 1/sfdd::SCALE : 1.0f), vector.y * (scaleToMeters ? 1/sfdd::SCALE : 1.0f));
    }
